...
Public Class p_ventas_00
    ...
    Private Sub p_ventas_00_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim comDoc As New MySqlCommand("select cod_docsunat,nom_doc from documento_s where activo=1 and (esVenta) order by nom_doc", dbConex)
        ...
        With cboDocumento
            ...
            .ValueMember = dsDocumento.Tables("documento_s").Columns("cod_docsunat").ToString
            .SelectedIndex = 0
        End With
        'dataset cliente
    ...
    Private Sub mostraritems(ByVal tipoSQL As Integer, ByVal codigo As String)
        ...
        Select Case tipoSQL
            ...
            Case 1
                ...
                'Llama a todos articulos de un subGrupo en específico
                'strSQL = ("select cod_art as codigo,nom_art as nombre,isnull(a.foto) as vnul,a.foto,if(length(a.b_color)>0,a.b_color,s.b_color) as b_color,s.f_color,f_tamano,pre_venta,afecto_igv,a.b_ancho,a.b_alto " _
                ...
                strSQL = ("select a.cod_art as codigo,a.nom_art as nombre,isnull(a.foto) as vnul,a.foto,if(length(a.b_color)>0,a.b_color,s.b_color) as b_color,s.f_color,f_tamano,ap.precio as pre_venta,afecto_igv,a.b_ancho,a.b_alto" _
                          ...
                          & " where a.activo and (t.esProductoterminado or t.esProduccion or t.esCombo) and a.cod_grupov='" & codigo & "' and pv.terminal='" & nombPC & "'")
                proceso = "A"
                panelitem.Controls.Clear()
            Case 2
                'tabventa.Text = "ITEMS DE VENTA"
            ...
            Case 6
                ...
                strSQL = "select a.cod_art as codigo,concat(space(5),nom_art) as nombre,isnull(a.foto) as vnul,s.b_color,f_color,f_tamano,a.foto, as pre_venta,afecto_igv,a.b_ancho,a.b_alto" _
                & " from articulo a inner join tipo_articulo t on a.cod_tart=t.cod_tart " _
    ...
    Sub grabadocumento(ByVal ser_doc As String, ByVal nro_doc As String)
        ...
        '            'el cliente y vendedor lo recuperamos al cargar el pedido
        Dim ctipdoc_ref, cserdoc_ref, cNumdoc_ref As String
    ...
    Sub grabadetalle()
        ...
        For I = 0 To dataDetalle.RowCount - 1
            If dataDetalle("comi_v", I).Value = 1 Then
                ...
                mfactura.insertar_factura_det(nroOperacion, nrofactura, 0, cod_art, cant, precio, pIGV, obs, imptotal, impsubtotal, impigv)
            End If
        Next
    ...
    Public Function PiedePagina(ByVal e As PrintPageEventArgs, ByVal prFont As Font, ByVal yPos As Single) As Single
        ...
        e.Graphics.DrawImage(imgQR.Image, leftmargin + 100, yPos)
        'Dim s As String
    ...
    Sub GeneraNumDocumento()
        ...
        txtNroDocumento.Text = mfactura.maxNrofactura(cboDocumento.SelectedValue, txtSerDocumento.Text)
    End Sub
