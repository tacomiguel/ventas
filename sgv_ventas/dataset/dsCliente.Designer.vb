...
Partial Public Class dsCliente
    ...
    Partial Public Class ClienteDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddClienteRow(ByVal nom_clie As String, ByVal cod_clie As String) As ClienteRow
            Dim rowClienteRow As ClienteRow = CType(Me.NewRow,ClienteRow)
            Dim columnValuesArray() As Object = New Object() {nom_clie, cod_clie}
    ...
    Partial Public Class ClienteRow
        ...
        Public Property cod_clie() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'cod_clie' de la tabla 'Cliente' es DBNull.", e)
                End Try
            End Get
            Set
